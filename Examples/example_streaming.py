...
#Setup streaming
sensor.writeStreamHz(1000) #caps at 2000
sensor.write_settings(stream_delay=0, stream_duration=0) #stream instantly on command, stream forever
...
sensor.writeStreamSlots(stream_slots_string)
print("Stream Slots:", sensor.readStreamSlots())

sensor.writeHeaderTimestampEnabled(1) #Enable the timestamp in the header to see the time at which the message was generated
sensor.writeTimestamp(0) #Set the timestamp back to 0 so the messages start from 0
